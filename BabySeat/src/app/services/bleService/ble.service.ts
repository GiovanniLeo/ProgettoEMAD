                                    ...
                                    (rssi) => {
                                        ...
                                        if (RSSI != null && RSSI > -79) {
                                            ...
                                            if (this.constDb.USER_OBJ !== null) {
                                                ...
                                                // getting the token device of the user, and sending via http to cloud function
                                                // for sending a cloud message to the device
                                                ...
                                                device.subscribe(tokenUser => {
                                                    ...
                                                    this.http.post('https://us-central1-babysafeseat-6b42d.cloudfunctions.net/' +
                                                        'sendNotification', jsonUser)
                                                        .subscribe((data) => {
